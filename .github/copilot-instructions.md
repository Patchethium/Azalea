...
- The app persists config as TOML. Debug builds use `config_dev/config.toml`; release builds use the OS config directory under the bundle identifier from `tauri.conf.json` (`com.azalea.app/`).
